...
export function AuthenticatedNavbar() {
    ...
    const handleLogout = async () => {
        try {
            ...
            toast.error(error.message || "Đăng xuất thất bại, vui lòng thử lại sau");
        }
    };
        ...
        <>
            ...
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <ul className="flex flex-col md:flex-row font-medium p-4 md:p-0 mt-4 md:mt-0 border md:border-0 rounded-lg md:space-x-8 bg-red-700 md:bg-transparent w-full items-center">
                    ...
                    <li className="md:flex items-center ml-auto md:ml-0">
                        <div className="flex items-center gap-2 mt-4 md:mt-0">
                            <Button
                                onClick={() => navigate("/login")}
                                variant="outline"
                                className="cursor-pointer bg-transparent text-white border-white hover:bg-[#E69207] hover:text-white"
                            >
                                Đăng nhập
                            </Button>
                            <Button
                                ...
                                variant="secondary"
                                className="cursor-pointer bg-[#F9AD2F] text-white hover:bg-[#E69207] hover:text-white"
                            >
                                Đăng ký
                            </Button>
                        </div>
